...
urlpatterns = [
    ...
    path('filter-penduduk', views.FilterPopulationRequestClassView.as_view(), name="filter_population_req"),
    ...
    path('manajemen-keluarga/export', views.ManajemenFamiliesExportClassView.as_view(), name="mnj_export_families"),
