...
class PopuliationsModels(models.Model):
    class Meta:
    ...
    r427 = models.CharField(max_length=1, blank=False, null=False, choices=r427_choices, verbose_name="Kondisi gizi anak dari pemeriksaan 3 bulan terakhir di posyandu/puskesmas/rumah sakit dengan mengacu pada buku kontrol (Umur 0-4)")
